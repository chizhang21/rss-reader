...
public class CollectionAdapter extends RecyclerView.Adapter<CollectionAdapter.LabelViewHolder> {

    private final static String TAG = CollectionAdapter.class.getSimpleName();
...
//            ButterKnife.bind(this, v);
    ...
    public CollectionAdapter(ArrayList<String> dataSet) {
    ...
    public LabelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.collection_item, null, false);
