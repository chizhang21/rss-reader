...
public class Settings extends Application {
    ...
    public static void setAccessToken(String tokenString) {
        getPreferences().edit().putString("access_token", tokenString).apply();
    }
    public static void setRefreshToken(String tokenString) {
        getPreferences().edit().putString("refresh_token", tokenString).apply();
    }
    ...
    public static void setGivenName(String name) {
        getPreferences().edit().putString("given_name", name).apply();
    }
    public static void setEmail(String email) {
        getPreferences().edit().putString("email", email).apply();
    }
    public static void setId(String id) {
        getPreferences().edit().putString("id", id).apply();
    }
    public static String getGivenName() {
        return getPreferences().getString("given_name", "");
    }
